...
using InventorySystem_API_Inderjeet.Data;
using InventorySystem_API_Inderjeet.Models;
...
namespace InventorySystem_API_Inderjeet.Controllers
{
    public class StockMaintainsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ID,CategoryID,ProductID,Quantity,Price,SoldItems,LeftItems")] StockMaintain stockMaintain)
        {
            ...
            ViewData["CategoryID"] = new SelectList(_context.Categories, "ID", "ID", stockMaintain.CategoryID);
            ViewData["ProductID"] = new SelectList(_context.Products, "ID", "ID", stockMaintain.ProductID);
            return View(stockMaintain);
        }
